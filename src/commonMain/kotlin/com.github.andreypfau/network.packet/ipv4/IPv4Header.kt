...
class IPv4Header : AbstractPacket.AbstractHeader, IpPacket.IpHeader {
    ...
    constructor(rawData: ByteArray, offset: Int, length: Int) {
        ...
        totalLength = rawData.getUShort(TOTAL_LENGTH_OFFSET + offset)
        identification = rawData.getUShort(IDENTIFICATION_OFFSET + offset)
        val flagsAndFragmentOffset = rawData.getShort(FLAGS_AND_FRAGMENT_OFFSET_OFFSET + offset)
        ...
        headerChecksum = rawData.getUShort(HEADER_CHECKSUM_OFFSET + offset)
