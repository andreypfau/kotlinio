...
import com.github.andreypfau.network.utils.shl
...
interface DnsHeader : Packet.Header {
    ...
    private class ByteBacked(
        ...
        override val id: UShort by lazy {
            _rawData.getUShort(ID_OFFSET + _offset)
        }
        private val flags: Int by lazy {
            _rawData.getUShort(FLAGS_OFFSET + _offset).toInt()
        }
        ...
        override val qdCount: UShort by lazy {
            _rawData.getUShort(QDCOUNT_OFFSET + _offset)
        }
        override val anCount: UShort by lazy {
            _rawData.getUShort(ANCOUNT_OFFSET + _offset)
        }
        override val nsCount: UShort by lazy {
            _rawData.getUShort(NSCOUNT_OFFSET + _offset)
        }
        override val arCount: UShort by lazy {
            _rawData.getUShort(ARCOUNT_OFFSET + _offset)
        }
