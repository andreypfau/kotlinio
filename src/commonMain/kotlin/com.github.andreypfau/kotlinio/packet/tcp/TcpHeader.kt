...
class TcpHeader : AbstractPacket.AbstractHeader, TransportHeader {
    ...
    constructor(rawData: ByteArray, offset: Int = 0, length: Int = rawData.size - offset) {
        ...
        acknowledgmentNumber = rawData.getUIntAt(ACKNOWLEDGMENT_NUMBER_OFFSET + offset)
        val dataOffsetAndReservedAndControlBits =
            rawData.getShortAt(DATA_OFFSET_AND_RESERVED_AND_CONTROL_BITS_OFFSET + offset).toInt()
        ...
        window = rawData.getUShortAt(WINDOW_OFFSET + offset)
