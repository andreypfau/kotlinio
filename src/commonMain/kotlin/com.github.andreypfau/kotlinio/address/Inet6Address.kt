...
class Inet6Address(
    ...
    private val _string by lazy {
        buildString {
            append(data.getUShortAt(offset).toString(16))
            append(":")
            append(data.getUShortAt(offset + Short.SIZE_BYTES).toString(16))
            append(":")
            append(data.getUShortAt(offset + Short.SIZE_BYTES * 2).toString(16))
            append(":")
            append(data.getUShortAt(offset + Short.SIZE_BYTES * 3).toString(16))
            append(":")
            append(data.getUShortAt(offset + Short.SIZE_BYTES * 4).toString(16))
            append(":")
            append(data.getUShortAt(offset + Short.SIZE_BYTES * 5).toString(16))
            append(":")
            append(data.getUShortAt(offset + Short.SIZE_BYTES * 6).toString(16))
            append(":")
            append(data.getUShortAt(offset + Short.SIZE_BYTES * 7).toString(16))
        }
    }
